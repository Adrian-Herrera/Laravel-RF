...
class FileUpload extends Component
{
    ...
    protected $rules = [
        'name' => 'required|min:6',
        'image_path' => 'required|image|mimes:jpeg,png,jpg,svg|max:5120',
    ];
    ...
    protected $messages = [
        ...
        'image_path.image' => 'Debe seleccionar una imagen de formato jpeg, png, jpg o svg.',
        'image_path.mimes' => 'Debe seleccionar una imagen de formato jpeg, png, jpg o svg.',
